...
class MAP_CLI_Command {
    ...
    public function recalculate($args, $assoc_args) {
        ...
        $first = MAP_Article_Health::recalculate_batch(0, $batch_size);
        $total = $first['total'];
        ...
        while ($processed < $total) {
            $result = MAP_Article_Health::recalculate_batch($processed, $batch_size);
...
WP_CLI::add_command('map', 'MAP_CLI_Command');
