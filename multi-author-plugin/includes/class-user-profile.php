...
class MAP_User_Profile {
    ...
    public function add_custom_user_fields($user) {
        ...
        <table class="form-table">
            ...
            <tr>
                <th>
                    <label for="map_show_on_team"><?php _e('Editorial Team', 'multi-author-plugin'); ?></label>
                </th>
                <td>
                    <label>
                        <input type="checkbox"
                        ...
                        <?php _e('Show on Editorial Team page', 'multi-author-plugin'); ?>
                    </label>
                    <p class="description">
                        <?php _e('Include this person in the [map_editorial_team] shortcode and Editorial Team block. Only administrators can change this.', 'multi-author-plugin'); ?>
                    </p>
                </td>
            </tr>
            <?php endif; ?>
    ...
    public function render_user_column_content($value, $column_name, $user_id) {
        ...
        if ($short_bio) {
            ...
            echo '<span class="description" style="color: #999;">' . esc_html__('No bio set', 'multi-author-plugin') . '</span>';
        }
