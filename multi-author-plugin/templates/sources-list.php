...
<div class="map-sources-section">
    <h3 class="map-sources-title">
        <?php echo esc_html(apply_filters('map_sources_title', __('Sources', 'multi-author-plugin'))); ?>
    </h3>
            ...
            <?php if (!empty($source['url'])) : ?>
                <li class="map-source-item">
                    <a href="<?php echo esc_url($source['url']); ?>"
                       ...
                       title="<?php echo esc_attr(!empty($source['label']) ? $source['label'] : __('View source', 'multi-author-plugin')); ?>">
                        <?php
