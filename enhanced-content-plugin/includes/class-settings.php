...
class ECP_Settings {
    ...
    public function add_settings_page() {
        add_options_page(
            __('Multi-Author Settings', 'enhanced-content-plugin'),
            __('Multi-Author', 'enhanced-content-plugin'),
            'manage_options',
            'ecp-settings',
    ...
    public function register_settings() {
        ...
        add_settings_section(
            'map_post_types',
            __('Post Types', 'enhanced-content-plugin'),
        ...
        add_settings_field(
            'enabled_post_types',
            __('Enable for Post Types', 'enhanced-content-plugin'),
        ...
        add_settings_section(
            'map_role_labels',
            __('Role Labels', 'enhanced-content-plugin'),
        ...
        add_settings_field(
            'label_written_by',
            __('Written By Label', 'enhanced-content-plugin'),
        ...
        add_settings_field(
            'label_coauthor',
            __('Co-Author Label', 'enhanced-content-plugin'),
            array($this, 'render_text_field'),
            'ecp-settings',
            'map_role_labels',
        ...
        add_settings_field(
            'label_reviewed_by',
            __('Reviewed By Label', 'enhanced-content-plugin'),
            array($this, 'render_text_field'),
            'ecp-settings',
            'map_role_labels',
        ...
        add_settings_field(
            ...
            __('Fact-Checked By Label', 'enhanced-content-plugin'),
            array($this, 'render_text_field'),
            'ecp-settings',
            'map_role_labels',
        ...
        add_settings_section(
            'map_expert_verified',
            __('Expert Verified Badge', 'enhanced-content-plugin'),
        ...
        add_settings_field(
            ...
            __('Enable Expert Verified Badge', 'enhanced-content-plugin'),
            ...
            array(
                ...
                'default' => false,
                'description' => __('Show an "Expert Verified" badge in the author byline area.', 'enhanced-content-plugin')
            )
        );

        add_settings_field(
            'expert_verified_label',
            __('Badge Label', 'enhanced-content-plugin'),
            array($this, 'render_text_field'),
            'ecp-settings',
            'map_expert_verified',
        ...
        add_settings_field(
            ...
            __('Popup Title', 'enhanced-content-plugin'),
            array($this, 'render_text_field'),
            'ecp-settings',
            'map_expert_verified',
        ...
        add_settings_field(
            ...
            __('Popup Content', 'enhanced-content-plugin'),
        ...
        add_settings_field(
            ...
            __('Link Text', 'enhanced-content-plugin'),
            array($this, 'render_text_field'),
            'ecp-settings',
            'map_expert_verified',
        ...
        add_settings_field(
            ...
            __('Link URL', 'enhanced-content-plugin'),
            array($this, 'render_text_field'),
            'ecp-settings',
            'map_expert_verified',
        ...
        add_settings_section(
            ...
            __('Editorial Process Link', 'enhanced-content-plugin'),
        ...
        add_settings_field(
            ...
            __('Enable Editorial Process Link', 'enhanced-content-plugin'),
            array($this, 'render_checkbox_field'),
            'ecp-settings',
            'map_editorial_process',
            array(
                ...
                'default' => false,
                'description' => __('Show "Learn more about our editorial process" link in all author popups.', 'enhanced-content-plugin')
            )
        );
        ...
        add_settings_field(
            ...
            __('Editorial Process Page URL', 'enhanced-content-plugin'),
            array($this, 'render_text_field'),
            'ecp-settings',
            'map_editorial_process',
        ...
        add_settings_section(
            'map_review_process',
            __('Review Process Link', 'enhanced-content-plugin'),
        ...
        add_settings_field(
            ...
            __('Enable Review Process Link', 'enhanced-content-plugin'),
            array($this, 'render_checkbox_field'),
            'ecp-settings',
            'map_review_process',
            array(
                ...
                'default' => false,
                'description' => __('Show "Learn more about our review process" link in reviewer popups.', 'enhanced-content-plugin')
            )
        );
        ...
        add_settings_field(
            'review_process_url',
            __('Review Process Page URL', 'enhanced-content-plugin'),
            array($this, 'render_text_field'),
            'ecp-settings',
            'map_review_process',
        ...
        add_settings_section(
            ...
            __('Fact-Check Process Link', 'enhanced-content-plugin'),
        ...
        add_settings_field(
            ...
            __('Enable Fact-Check Process Link', 'enhanced-content-plugin'),
            array($this, 'render_checkbox_field'),
            'ecp-settings',
            'map_factcheck_process',
            array(
                ...
                'default' => false,
                'description' => __('Show "Learn more about our fact-checking process" link in fact-checker popups.', 'enhanced-content-plugin')
            )
        );
        ...
        add_settings_field(
            ...
            __('Fact-Check Process Page URL', 'enhanced-content-plugin'),
            array($this, 'render_text_field'),
            'ecp-settings',
            'map_factcheck_process',
        ...
        add_settings_section(
            'map_display_options',
            __('Display Options', 'enhanced-content-plugin'),
        ...
        add_settings_field(
            'hide_theme_author',
            __('Hide Theme Author Byline', 'enhanced-content-plugin'),
            array($this, 'render_checkbox_field'),
            'ecp-settings',
            'map_display_options',
            array(
                ...
                'default' => false,
                'description' => __('Hide the default WordPress/theme author byline to prevent duplicate author display. The plugin will display all authors including the primary author in a consistent format.', 'enhanced-content-plugin')
            )
        );

        add_settings_field(
            'skip_primary_author',
            __('Skip Primary Author in Plugin Display', 'enhanced-content-plugin'),
            array($this, 'render_checkbox_field'),
            'ecp-settings',
            'map_display_options',
            array(
                ...
                'default' => false,
                'description' => __('Use WordPress/theme default for the primary author (with date). The plugin will only display co-authors, reviewers, and fact-checkers.', 'enhanced-content-plugin')
            )
        );

        $placement_options = array(
            'auto' => __('Automatic (added to content)', 'enhanced-content-plugin'),
            'manual' => __('Manual (use shortcode or block)', 'enhanced-content-plugin')
        );

        add_settings_field(
            'contributors_placement',
            __('Contributor Badges Placement', 'enhanced-content-plugin'),
            ...
            array(
                ...
                'description' => __('Manual: place with the [map_contributors] shortcode or the Contributors block.', 'enhanced-content-plugin')
            )
        );

        add_settings_field(
            'sources_placement',
            __('Sources Placement', 'enhanced-content-plugin'),
            array($this, 'render_select_field'),
            'ecp-settings',
            'map_display_options',
            array(
                ...
                'default' => 'auto',
                'options' => $placement_options,
                'description' => __('Manual: place with the [map_sources] shortcode or the Sources block.', 'enhanced-content-plugin')
            )
        );

        add_settings_field(
            'faq_placement',
            __('FAQ Placement', 'enhanced-content-plugin'),
            array($this, 'render_select_field'),
            'ecp-settings',
            'map_display_options',
            array(
                ...
                'default' => 'auto',
                'options' => $placement_options,
                'description' => __('Manual: place with the [map_faq] shortcode or the FAQ block.', 'enhanced-content-plugin')
            )
        );

        add_settings_field(
            'author_archive_credits',
            __('Author Archive Credits', 'enhanced-content-plugin'),
            array($this, 'render_checkbox_field'),
            'ecp-settings',
            'map_display_options',
            array(
                ...
                'default' => false,
                'description' => __('On author archive pages, show how many articles the person has reviewed and fact-checked.', 'enhanced-content-plugin')
            )
        );

        add_settings_field(
            'disable_article_schema',
            __('Disable Article Schema', 'enhanced-content-plugin'),
            array($this, 'render_checkbox_field'),
            'ecp-settings',
            'map_display_options',
            array(
                ...
                'default' => false,
                'description' => __('Turn off this plugin\'s Article JSON-LD output. Enable this if your SEO plugin (Yoast, Rank Math, AIOSEO) already outputs Article schema.', 'enhanced-content-plugin')
            )
        );
        ...
        add_settings_section(
            'map_primary_styling',
            __('Primary Author Row Styling', 'enhanced-content-plugin'),
        ...
        add_settings_field(
            'primary_show_avatar',
            __('Show Primary Author Avatar', 'enhanced-content-plugin'),
            array($this, 'render_checkbox_field'),
            'ecp-settings',
            'map_primary_styling',
            array(
                ...
                'default' => true,
                'description' => __('Display avatar/photo for the primary author in the byline row.', 'enhanced-content-plugin')
            )
        );

        add_settings_field(
            'primary_avatar_size',
            __('Primary Author Avatar Size (px)', 'enhanced-content-plugin'),
        ...
        add_settings_field(
            'primary_font_size',
            __('Primary Author Font Size (px)', 'enhanced-content-plugin'),
            array($this, 'render_number_field'),
            'ecp-settings',
            'map_primary_styling',
        ...
        add_settings_section(
            'map_styling',
            __('Contributors Styling (Co-authors, Reviewers, Fact-checkers)', 'enhanced-content-plugin'),
        ...
        add_settings_field(
            ...
            __('Show Contributor Avatars', 'enhanced-content-plugin'),
            array($this, 'render_checkbox_field'),
            'ecp-settings',
            'map_styling',
            array(
                ...
                'default' => true,
                'description' => __('Display avatars/photos for co-authors, reviewers, and fact-checkers.', 'enhanced-content-plugin')
            )
        );

        add_settings_field(
            'avatar_size',
            __('Contributor Avatar Size (px)', 'enhanced-content-plugin'),
            array($this, 'render_number_field'),
            'ecp-settings',
            'map_styling',
        ...
        add_settings_field(
            'name_font_size',
            __('Contributor Name Font Size (px)', 'enhanced-content-plugin'),
            array($this, 'render_number_field'),
            'ecp-settings',
            'map_styling',
        ...
        add_settings_field(
            'title_font_size',
            __('Job Title Font Size (px)', 'enhanced-content-plugin'),
            array($this, 'render_number_field'),
            'ecp-settings',
            'map_styling',
        ...
        add_settings_field(
            ...
            __('Role Label Font Size (px)', 'enhanced-content-plugin'),
            array($this, 'render_number_field'),
            'ecp-settings',
            'map_styling',
        ...
        add_settings_field(
            'name_color',
            __('Name Text Color', 'enhanced-content-plugin'),
        ...
        add_settings_field(
            'title_color',
            __('Job Title Text Color', 'enhanced-content-plugin'),
            array($this, 'render_color_field'),
            'ecp-settings',
            'map_styling',
        ...
        add_settings_field(
            'role_label_color',
            __('Role Label Text Color', 'enhanced-content-plugin'),
            array($this, 'render_color_field'),
            'ecp-settings',
            'map_styling',
        ...
        add_settings_section(
            'map_ai_disclosure',
            __('AI Disclosure Settings', 'enhanced-content-plugin'),
        ...
        add_settings_field(
            'ai_disclaimer_page',
            __('AI Disclaimer Page URL', 'enhanced-content-plugin'),
            ...
            array(
                ...
                'default' => '',
                'description' => __('Link to your AI usage policy/disclaimer page. This will be shown in the AI badge popup.', 'enhanced-content-plugin')
            )
        );
    }
    ...
    public function render_ai_disclosure_section() {
        echo '<p>' . __('Configure AI disclosure badge settings. The AI badge can be enabled per-post in the AI Disclosure Badge meta box when editing posts.', 'enhanced-content-plugin') . '</p>';
    }
    ...
    public function render_post_types_section() {
        echo '<p>' . esc_html__('Choose which content types get the contributor, sources, FAQ, and schema features.', 'enhanced-content-plugin') . '</p>';
    }
    ...
    public function render_post_types_field($args) {
        ...
        echo '<p class="description">' . esc_html__('The Article Health dashboard always tracks standard posts only.', 'enhanced-content-plugin') . '</p>';
    }
    ...
    public function render_role_labels_section() {
        echo '<p>' . __('Customize the text labels for different contributor roles.', 'enhanced-content-plugin') . '</p>';
    }
    ...
    public function render_expert_verified_section() {
        echo '<p>' . __('Add an "Expert Verified" badge with a hover popup to show content credibility. Enable here globally, then toggle per-post in the Article Contributors meta box.', 'enhanced-content-plugin') . '</p>';
    }
    ...
    public function render_editorial_process_section() {
        echo '<p>' . __('Add a link to your editorial process page at the bottom of author hover popups. Enable here, then toggle per-post in the Article Contributors meta box.', 'enhanced-content-plugin') . '</p>';
    }
    ...
    public function render_review_process_section() {
        echo '<p>' . __('Add a link to your review process page at the bottom of reviewer hover popups. Enable here, then toggle per-post in the Article Contributors meta box.', 'enhanced-content-plugin') . '</p>';
    }
    ...
    public function render_factcheck_process_section() {
        echo '<p>' . __('Add a link to your fact-checking process page at the bottom of fact-checker hover popups. Enable here, then toggle per-post in the Article Contributors meta box.', 'enhanced-content-plugin') . '</p>';
    }
    ...
    public function render_display_options_section() {
        echo '<p>' . __('Control how author information is displayed on your site.', 'enhanced-content-plugin') . '</p>';
    }
    ...
    public function render_primary_styling_section() {
        echo '<p>' . __('Customize the appearance of the primary author byline row (with date).', 'enhanced-content-plugin') . '</p>';
    }
    ...
    public function render_styling_section() {
        echo '<p>' . __('Customize the appearance of co-authors, reviewers, and fact-checkers.', 'enhanced-content-plugin') . '</p>';
    }
    ...
    public function render_settings_page() {
        ...
        if (isset($_GET['settings-updated'])) {
            add_settings_error(
                'map_messages',
                'map_message',
                __('Settings Saved', 'enhanced-content-plugin'),
                'updated'
            );
        }
        ...
        <div class="wrap">
            ...
            <form action="options.php" method="post">
                ...
                submit_button(__('Save Settings', 'enhanced-content-plugin'));
                ?>
            </form>
            
            <?php $preview = $this->get_settings(); ?>
            <div class="map-settings-preview">
                <h2><?php _e('Live Preview', 'enhanced-content-plugin'); ?></h2>
                <p class="description"><?php _e('Updates as you change styling options. Save to apply on your site.', 'enhanced-content-plugin'); ?></p>
                ...
                <div id="map-live-preview" style="background: #fff; border: 1px solid #c3c4c7; border-radius: 4px; padding: 20px; max-width: 640px;">
                    ...
                    <div class="map-preview-primary" style="display: flex; align-items: center; gap: 8px; font-size: <?php echo intval($preview['primary_font_size']); ?>px;">
                        <span><?php esc_html_e('By', 'enhanced-content-plugin'); ?></span>
    ...
    public function enqueue_settings_assets($hook) {
        if ('settings_page_ecp-settings' !== $hook) {
            return;
        }
        ...
        wp_enqueue_style(
            'map-settings-styles',
            ECP_PLUGIN_URL . 'admin/css/settings-styles.css',
            array(),
            ECP_VERSION
        );
        ...
        wp_enqueue_script(
            ...
            ECP_PLUGIN_URL . 'admin/js/settings-scripts.js',
