...
class ECP_FAQ {
    ...
    public function add_faq_meta_box() {
        add_meta_box(
            'map_faq',
            __('FAQ Section', 'enhanced-content-plugin'),
            array($this, 'render_faq_meta_box'),
            ECP_Settings::get_enabled_post_types(),
            'normal',
            'default'
        );
    }
    ...
    public function render_faq_meta_box($post) {
        ...
        if (empty($faq_title)) {
            $faq_title = __('Frequently Asked Questions', 'enhanced-content-plugin');
        }

        ?>
        <div class="map-faq-wrapper">
            <p class="description">
                <?php _e('Add a FAQ section to this article. FAQ schema will be automatically added for SEO.', 'enhanced-content-plugin'); ?>
            </p>
            ...
            <div class="map-faq-enable">
                <label>
                    ...
                    <strong><?php _e('Enable FAQ section for this article', 'enhanced-content-plugin'); ?></strong>
                </label>
            </div>
            ...
            <div class="map-faq-settings" id="map-faq-settings" style="<?php echo $faq_enabled !== '1' ? 'display: none;' : ''; ?>">
                ...
                <div class="map-faq-title-field">
                    <label for="map_faq_title">
                        <strong><?php _e('FAQ Section Title', 'enhanced-content-plugin'); ?></strong>
                    </label>
                    <input type="text"
                           id="map_faq_title"
                           name="map_faq_title"
                           ...
                           class="widefat"
                           placeholder="<?php esc_attr_e('Frequently Asked Questions', 'enhanced-content-plugin'); ?>" />
                </div>

                <!-- FAQ Items -->
                <div class="map-faq-items-header">
                    <h4><?php _e('FAQ Items', 'enhanced-content-plugin'); ?></h4>
                    <p class="description"><?php _e('Add questions and answers. Each FAQ item will include schema markup.', 'enhanced-content-plugin'); ?></p>
                </div>
                ...
                <button type="button" class="button" id="map-add-faq">
                    ...
                    <?php _e('Add FAQ Item', 'enhanced-content-plugin'); ?>
                </button>
            </div>
        </div>
        ...
        <script type="text/template" id="map-faq-template">
            <div class="map-faq-item" data-index="{{INDEX}}">
                <div class="map-faq-item-header">
                    ...
                    <button type="button" class="button-link map-faq-toggle" aria-label="<?php esc_attr_e('Toggle', 'enhanced-content-plugin'); ?>">
                        <span class="dashicons dashicons-arrow-down-alt2"></span>
                    </button>
                    <button type="button" class="button-link map-remove-faq" aria-label="<?php esc_attr_e('Remove', 'enhanced-content-plugin'); ?>">
                        <span class="dashicons dashicons-trash"></span>
                    </button>
                </div>
                <div class="map-faq-item-content">
                    <div class="map-faq-field">
                        <label><?php _e('Question', 'enhanced-content-plugin'); ?></label>
                        <input type="text"
                               name="map_faq[{{INDEX}}][question]"
                               class="map-faq-question widefat"
                               value=""
                               placeholder="<?php esc_attr_e('Enter the question...', 'enhanced-content-plugin'); ?>" />
                    </div>
                    <div class="map-faq-field">
                        <label><?php _e('Answer', 'enhanced-content-plugin'); ?></label>
                        <textarea name="map_faq[{{INDEX}}][answer]"
                                  class="map-faq-answer widefat"
                                  rows="4"
                                  placeholder="<?php esc_attr_e('Enter the answer...', 'enhanced-content-plugin'); ?>"></textarea>
                        <p class="description"><?php _e('You can use basic HTML tags for formatting.', 'enhanced-content-plugin'); ?></p>
                    </div>
                </div>
            </div>
        </script>
            ...
            <div class="map-faq-item-content" style="display: none;">
                ...
                <div class="map-faq-field">
                    ...
                    <textarea name="map_faq[<?php echo esc_attr($index); ?>][answer]"
                              class="map-faq-answer widefat"
                              rows="4"
                              placeholder="<?php esc_attr_e('Enter the answer...', 'enhanced-content-plugin'); ?>"><?php echo esc_textarea($answer); ?></textarea>
                    <p class="description"><?php _e('You can use basic HTML tags for formatting.', 'enhanced-content-plugin'); ?></p>
                </div>
            </div>
        </div>
    ...
    public function add_faq_to_content($content) {
        ...
        if ('manual' === ECP_Settings::get_setting('faq_placement', 'auto')) {
            return $content;
        }
    ...
    public function render_faq_section($post_id) {
        ...
        $template = ECP_Frontend_Display::locate_template('faq-section.php');
