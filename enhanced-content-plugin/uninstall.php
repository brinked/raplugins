...
// --- Agent tables ---------------------------------------------------------
foreach (array('ecp_runs', 'ecp_opportunities', 'ecp_proposals', 'ecp_events', 'ecp_metrics', 'ecp_clusters', 'ecp_inventory', 'ecp_roadmap', 'ecp_facts', 'ecp_topics', 'ecp_briefs') as $table) {
